...
public class ProjectServiceImpl  implements ProjectService {
    ...
    public ProjectReadDto getProject(int id) {
        ...
        return project.map(value -> new ProjectReadDto(
                value.getProject_id(),
                value.getName(),
                value.getDescription(),
                value.getProduct_owner_id(),
                value.getScrum_master_id(),
                value.getStart_date(),
                value.getEstimated_end_date(),
                value.getActual_end_date(),
                value.getDefinition_of_done(),
                value.getStatus()
        )).orElse(null);
